...
training_pipeline_files = [
    "training/configuration_manager/_init_.py",
    ...
    "training/entity/_init_.py",
    "training/entity/config_entity.py",
    "training/utils/_init_.py",
    "training/utils/common.py",
    "training/constants/_init_.py",
    "training/_init_.py",
]
...
deployment_pipeline_files = [
    ...
    "deployment/configuration_manager/_init_.py",
    ...
    "deployment/components/_init_.py",
    ...
    "deployment/entity/_init_.py",
    "deployment/entity/config_entity.py",
    "deployment/utils/_init_.py",
    "deployment/utils/common.py",
    "deployment/constants/_init_.py",
    "deployment/_init_.py",
]
